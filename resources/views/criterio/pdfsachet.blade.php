...
<main>
    ...
    <table class="correcciones mt font">
        <tbody>
            <tr>
                <th colspan="4">BOLSA PAPEL BIODEGRADABLE-ID: {{$item->id_sap_envase}}</th>
            </tr>
            <tr>
            ...
            <tr>
                <th colspan="4">Etiqueta Frontal-ID: {{$item->id_sap_tapa}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            <tr>
                <th colspan="4">ETIQUETA AL REVERSO-ID: {{$item->id_sap_sello}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            <tr>
                <th colspan="4">LAMINADO/SACHET-ID: {{$item->id_sap_pegotin}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            @foreach ($empaque as $item)
             <tr>
                <th colspan="4">ETIQUETADO DE LA BOLSA</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            @foreach ($codificado as $item)
             <tr>
                <th colspan="4">CADUCIDAD EN SACHET</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            @foreach ($codificado as $item)
            <tr>
               <th colspan="4">LOTE Y CADUCIDAD EN BOLSA:</th>
           </tr>
           <tr>
               <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
               <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
           ...
           @foreach ($sellado as $item)
             <tr>
                <th colspan="4">CONDICIONES DE SACHET</th>
            </tr>
            <tr>
                <td ><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="3"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            </tr>
            <tr>
                <td ><center><img width="120" height="auto" src="img/criterio/{{$item->img_si_acondicion}}" alt=""></center></td>
                 ...
                 <td><center><img width="120" height="auto" src="img/criterio/{{$item->img_aux_1}}" alt=""></center></td>
                 <td><center><img width="120" height="auto" src="img/criterio/{{$item->img_aux_2}}" alt=""></center></td>
    ...
    <table class="correcciones mt font">
        <tbody>
            ...
            <tr>
                <th colspan="4">CORRUGADO-ID:{{$item->sap_id_corrugado}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
