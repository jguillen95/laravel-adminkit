...
<main>
    ...
    <table class="correcciones mt font">
        <tbody>
            ...
            @endforeach
            @foreach ($liquidos as $item)
                
            
            <tr>
                <th colspan="4">Etiqueta-ID: {{$item->sap_id_etiqueta}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            <tr>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_si_etiqueta}}" alt=""></center></td>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_no_etiqueta}}" alt=""></center></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_si_etiqueta_1}}" alt=""></center></td>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_no_etiqueta_1}}" alt=""></center></td>
            </tr>
            <tr>
                <td colspan="2">{{$item->desc_si_etiqueta_1}}</td>
                <td colspan="2">{{$item->desc_no_etiqueta_1}}</td>
            </tr>
            <tr>
                <th colspan="4">GOTERO-ID: {{$item->sap_id_gotero}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            <tr>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_si_gotero}}" alt=""></center></td>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_no_gotero}}" alt=""></center></td>
            </tr>
            <tr>
                <td colspan="2">{{$item->desc_si_gotero}}</td>
                <td colspan="2">{{$item->desc_no_gotero}}</td>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            <tr>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_si_dedal}}" alt=""></center></td>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_no_dedal}}" alt=""></center></td>
            </tr>
            <tr>
                <td colspan="2">{{$item->desc_si_dedal}}</td>
                <td colspan="2">{{$item->desc_no_dedal}}</td>
            </tr>
            @endforeach
            @foreach ($polvos as $item)
             <tr>
                <th colspan="4">SELLO TERMOENCOGIBLE-ID: {{$item->sap_id_termo}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
    ...
    <table class="correcciones mt font">
     ...
     @foreach ($corrugado as $item)
            ...
            <tr>
                <td colspan="2"><center><img width="120" height="auto" src="img/criterio/{{$item->img_si_corrugado}}" alt=""></center></td>
