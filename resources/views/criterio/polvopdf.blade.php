...
<main>
    ...
    <table class="correcciones mt font">
        <tbody>
            <tr>
                <th colspan="4">Bolsa: {{$item->id_sap_envase}}</th>
            </tr>
            <tr>
            ...
            <tr>
                <th colspan="4">CUCHARA DOSIFICADORA-ID: {{$item->id_sap_tapa}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            <tr>
                <th colspan="4">Separador-ID: {{$item->id_sap_sello}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
    ...
    <table class="correcciones mt font">
        <tbody>
            <tr>
                <th colspan="4">LOTE Y CADUCIDAD</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
            ...
            <tr>
                <td colspan="4"><strong>Lote en envase: {{$item->lote_envase_c}}</strong> <br> <strong>{{$item->cad_envase_c}}</strong></td>
            </tr>
        </tbody>
    </table>
    @endforeach
    ...
    <p><strong>ACONDICIONAMIENTO PT</strong></p>
    <table class="correcciones mt font">
        <tbody>
            <tr>
                <th colspan="4">EMBALAJE-ID:{{$item->sap_id_acondicion}}</th>
            </tr>
            <tr>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/paloma.png" alt=""></center></td>
                <td colspan="2"><center><img width="30" height="auto" src="img/criterio/tache.png" alt=""></center></td>
