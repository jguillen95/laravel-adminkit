...
class SachetController extends Controller
{
     ...
     *
     * @param  \App\Models\Sachet  $sachet
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        ...
        $pdf= Pdf::loadView('criterio.pdfsachet', compact('empaque','criterio','mezcla','sellado','codificado','corrugado'))
        ->setPaper('a4', 'portrait');
        return $pdf->stream('criterio.pdfsachet');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Sachet $sachet)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Sachet $sachet)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Sachet $sachet)
    {
        //
    }
}
